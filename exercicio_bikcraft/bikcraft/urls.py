...
urlpatterns = [
    ...
    path('erro_cadastraprodutos', views.erro_cadastraprodutos, name='erro-cadastraprodutos'),
    path('produtos/', views.produtos, name='pagina-produtos'),
    path('contados/', views.contados, name='pagina-contados'),
    path('erro_contados', views.erro_contados, name='erro-contados'),
    ...
    path('erro_atualizado', views.erro_atualizado, name='erro-atualizado'),
